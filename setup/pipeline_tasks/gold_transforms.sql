-- Gold Layer Transforms for Enterprise RCA Intelligence Pipeline
-- Creates 5 analytics-ready gold tables from silver data
-- Run against: jnj_eo_demo.eo_analytics_plane
--
-- Updated for JnJ business unit schema with:
--   business_unit, total_affected_users, servicenow_tickets, revenue_model
-- New table: gold_business_impact_summary

-- ============================================================================
-- gold_root_cause_patterns: Recurring failure pattern analysis
-- ============================================================================
CREATE OR REPLACE TABLE jnj_eo_demo.eo_analytics_plane.gold_root_cause_patterns AS
WITH pattern_stats AS (
  ...
  FROM jnj_eo_demo.eo_analytics_plane.silver_incidents
...
-- ============================================================================
-- gold_service_risk_ranking: Composite risk scoring per service
-- ============================================================================
CREATE OR REPLACE TABLE jnj_eo_demo.eo_analytics_plane.gold_service_risk_ranking AS
...
health_stats AS (
  ...
  FROM jnj_eo_demo.eo_analytics_plane.silver_service_health
...
change_stats AS (
  ...
  FROM jnj_eo_demo.eo_analytics_plane.silver_changes
  GROUP BY service
)
SELECT
...
-- ============================================================================
-- gold_change_incident_correlation: Change-incident causal analysis
-- ============================================================================
CREATE OR REPLACE TABLE jnj_eo_demo.eo_analytics_plane.gold_change_incident_correlation AS
WITH change_incident_pairs AS (
  ...
  FROM jnj_eo_demo.eo_analytics_plane.silver_changes c
  JOIN jnj_eo_demo.eo_analytics_plane.silver_incidents i
...
-- ============================================================================
-- gold_domain_impact_summary: Daily domain-level impact aggregation
-- ============================================================================
CREATE OR REPLACE TABLE jnj_eo_demo.eo_analytics_plane.gold_domain_impact_summary AS
...
domain_alerts AS (
  ...
  FROM jnj_eo_demo.eo_analytics_plane.silver_alerts
...
-- ============================================================================
-- gold_business_impact_summary: Per-business-unit aggregation (NEW)
-- ============================================================================
CREATE OR REPLACE TABLE jnj_eo_demo.eo_analytics_plane.gold_business_impact_summary AS
SELECT
  i.business_unit,
  ...
  current_timestamp() as computed_at
FROM jnj_eo_demo.eo_analytics_plane.silver_incidents i
